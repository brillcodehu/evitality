...
const counterData = [
  { number: 987, title: "Elégedett ügyfél", styleChange: "col-6" },
  { number: 845, title: "Lefutott edzés", styleChange: "col-6" },
  { number: 789, title: "Online konzultáció", styleChange: "col-12" },
];
